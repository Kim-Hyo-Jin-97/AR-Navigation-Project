...
https://github.com/Unity-Team-Unreal/AR-nav.git
...
네비게이션 앱 UI를 디자인하면서 마커 범례를 구분하는 방법으로 enum과 기준점이 될 static enum 객체를 만들고, 각 마커가 기준점 enum객체와 자신의 enum값을 비교하는 함수를 update에 넣는 방법을 사용하였습니다.<br>
